...
function Home() {
  return (
    <div className=" flex flex-col items-center my-[100px] mx-auto w-[357px] h-[311px] top-[204px] left-[17px] gap-[50px] custom:max-w-[941px] sm:h-[265px] sm:gap-[50px] sm:max-w-[85%]">
