...
function SignUp() {
  ...
  return (
    ...
    >
      ...
      {/* SIGNUP PAGE*/}
      <div className="w-full min-w-[24rem] max-w-[65%] mx-auto custom:w-[25rem] max-lg:w-[540px] flex  order-0 custom:order-1 flex-col flex-none  h-[786px] self-stretch items-start p-[30px] sm:p-[40px] gap-[30px] sm:h-[816px] bg-white rounded-[10px] space-y-2">
